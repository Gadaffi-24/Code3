import DescriptionLandscaping from '../imports/DescriptionLandscaping';

interface LandscapingDetailPageProps {
  onNavigate?: (page: string) => void;
  onEnrollNow?: (courseId: string) => void;
  onAddToCart?: (courseId: string) => void;
}

export default function LandscapingDetailPage({ onNavigate, onEnrollNow, onAddToCart }: LandscapingDetailPageProps) {
