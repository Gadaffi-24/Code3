import DescriptionLifeSkills from '../imports/DescriptionLifeSkills';

interface LifeSkillsDetailPageProps {
  onNavigate?: (page: string) => void;
  onEnrollNow?: (courseId: string) => void;
  onAddToCart?: (courseId: string) => void;
}

export default function LifeSkillsDetailPage({ onNavigate, onEnrollNow, onAddToCart }: LifeSkillsDetailPageProps) {
