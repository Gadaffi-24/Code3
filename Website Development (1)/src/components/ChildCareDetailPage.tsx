import DescriptionChildCare from '../imports/DescriptionChildCare';

interface ChildCareDetailPageProps {
  onNavigate?: (page: string) => void;
  onEnrollNow?: (courseId: string) => void;
  onAddToCart?: (courseId: string) => void;
}

export default function ChildCareDetailPage({ onNavigate, onEnrollNow, onAddToCart }: ChildCareDetailPageProps) {
