import DescriptionFirstAid from '../imports/DescriptionFirstAid';

interface FirstAidDetailPageProps {
  onNavigate?: (page: string) => void;
  onEnrollNow?: (courseId: string) => void;
  onAddToCart?: (courseId: string) => void;
}

export default function FirstAidDetailPage({ onNavigate, onEnrollNow, onAddToCart }: FirstAidDetailPageProps) {
